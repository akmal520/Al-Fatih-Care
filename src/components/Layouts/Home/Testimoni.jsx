        ...
        <section className="container mx-auto my-16" id="testimoni">
            <main className="pt-24 flex flex-col items-center gap-10">
                <div className="text-center inline-flex flex-col gap-4 lg:w-[676px]">
                    <h1 className="text-dark text-2xl lg:text-3xl font-poppins font-semibold not-italic leading-normal capitalize">
                        testimonial by pasien
                    </h1>
                    <p className="text-second font-sora text-sm lg:text-base not-italic font-normal leading-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                    {[1, 2, 3, 4].map((item, index) => (
                        <div className=" lg:w-[471px] p-8 bg-white hover:shadow-[0px_24px_32px_-3px_rgba(3,9,50,0.15)] rounded-[32px] inline-flex flex-col items-start gap-3 border border-gray-100 hover:scale-105 transition-all duration-300 ease-in-out select-none">
